[_tb_system_call storage=system/_chapter_1_church.ks]
...
He saw it all, he just chose to do nothing.[p]
[_tb_end_text]

[bg  time="1000"  method="crossfade"  storage="background/church.png"  ]
[chara_show  name="Kai"  time="1000"  wait="true"  storage="chara/2/Kai_pose_2_ai.png"  width="682"  height="1214"  left="435"  top="-181"  reflect="false"  ]
[chara_show  name="An"  time="1000"  wait="true"  storage="chara/1/An_concern.png"  width="525"  height="933"  left="-28"  top="233"  reflect="false"  ]
[tb_start_text mode=1 ]
#An
...
[tb_start_text mode=1 ]
#Kai
This is not the first time i played a human role, An.[p]
...
[chara_move  name="Kai"  anim="false"  time="300"  effect="linear"  wait="true"  left="671"  top="-142"  width="626"  height="1115"  ]
[chara_show  name="Lan"  time="1000"  wait="true"  storage="chara/11/Lan_1_bruh_face.png"  width="218"  height="672"  left="385"  top="124"  reflect="false"  ]
[tb_start_text mode=1 ]
#Lan
...
[chara_show  name="Kai"  time="1000"  wait="true"  storage="chara/2/Kai_2_talk.png"  width="591"  height="1052"  left="595"  top="-123"  reflect="false"  ]
[tb_start_text mode=1 ]
#Kai
