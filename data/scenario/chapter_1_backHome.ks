[_tb_system_call storage=system/_chapter_1_backHome.ks]
...
Faust, for wanting to have unlimited knowledge about this world, made a contract with the demon.[p]
He found lands and fought wars, went through tragedies and struggles like no one ever went through ad achieved things like no one ever achieved.[p]
...
[tb_start_text mode=1 ]
#Kai
Leaving Mephisto's love sick self to suffer for the rest of eternity[p]
[_tb_end_text]
